...
const MUSLIM_HIKING_FAQS = FAQS;
const MUSLIM_HIKING_UK_FAQS = [
  { q: "Where can I go Muslim hiking in the UK?", a: "Muslim hiking groups run regular trips across the Lake District, Peak District, Snowdonia (Eryri), Yorkshire Dales, Brecon Beacons, South Downs, Kent Downs, and the Scottish Highlands. Badr Adventures runs guided weekends in every major UK range, all year round." },
  { q: "Is there a Muslim hiking group near me?", a: "Most major UK cities are within two hours of at least one Muslim hiking group. London, Manchester, Birmingham, Leeds, Bradford, Leicester, Glasgow, Edinburgh, Cardiff and Bristol all have active groups. Badr Adventures is based in Cumbria and runs nationwide weekends." },
  { q: "How much does a guided Muslim hiking trip cost?", a: "A day-walk with a qualified Muslim hiking guide costs roughly £35–£75 per person, including guide fees, packed lunch and group kit. An overnight expedition (camp or bunkhouse) typically runs £120–£220." },
  { q: "Do I need my own hiking gear?", a: "Day-walks: you need boots, a waterproof jacket and a daypack. We can lend kit on a first-come basis. Overnight trips: Badr Adventures rents full kit lists through the Rent page, delivered to your meeting point." },
